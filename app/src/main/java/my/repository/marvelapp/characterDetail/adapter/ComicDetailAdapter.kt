...
class ComicDetailAdapter (private var items: MutableList<Comic.Results>) : RecyclerView.Adapter<ComicDetailAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        return ComicDetailAdapter.ViewHolder(inflater.inflate(R.layout.item_comics, parent, false))
    }
