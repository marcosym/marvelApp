...
class SeriesDetailAdapter (private var items: MutableList<Comic.Results>) : RecyclerView.Adapter<SeriesDetailAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        return SeriesDetailAdapter.ViewHolder(inflater.inflate(R.layout.item_series, parent, false))
    }
